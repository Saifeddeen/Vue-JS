        ...
        <div class="container flex">
            ...
            <div class="flex items-center justify-between flex-grow pl-12">
                ...
                <template v-if="userStore.user.id">
                    <a @click.prevent="logout()" class="text-gray-200 hover:text-white transition mx-2 cursor-pointer">Logout</a>
                </template>
                <div v-else class="flex items-center space-x-6 capitalize">
                    <router-link to="/login" class="text-gray-200 hover:text-white transition mx-2">Login</router-link>
                    <router-link to="/register" class="text-gray-200 hover:text-white transition mx-2">Register</router-link>
                </div>
            </div>
        </div>
    </nav>
