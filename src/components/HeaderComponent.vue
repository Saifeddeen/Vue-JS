<template>
    ...
    <header class="py-4 shadow-sm bg-white">
        <div class="container flex items-center justify-between">
            ...
            <div v-if="userStore.user.id" class="flex items-center space-x-4">
                <router-link to="/wishlist" class="text-center text-gray-700 hover:text-primary transition relative">
                    ...
                    <div
                        ...
                        {{ userStore.user.wishlist.length }}</div>
                </router-link>
                <a href="#" class="text-center text-gray-700 hover:text-primary transition relative">
                    ...
                    <div
                        ...
                        {{ userStore.user.cart.length }}</div>
                </a>
                <a href="#" class="text-center text-gray-700 hover:text-primary transition relative">
                    <div class="text-2xl">
                        <i class="fa-regular fa-user"></i>
                    </div>
                    <div class="text-xs leading-3">{{ userStore.user.name }}</div>
                </a>
            </div>
        </div>
    </header>
